...
function polling(request$, userOptions, scheduler) {
    ...
    return rxjs_1.fromEvent(document, 'visibilitychange')
        .pipe(operators_1.startWith(null), operators_1.switchMap(function () {
        if (isPageActive()) {
            return rxjs_1.interval(options.interval, scheduler)
                .pipe(operators_1.startWith(null), // Immediately run the first call
            operators_1.switchMap(function () { return request$; }), operators_1.retryWhen(function (errors$) {
                return errors$
                    .pipe(operators_1.scan(function (_a, err) {
                    ...
                    return rxjs_1.timer(delay, null, scheduler);
                }));
            }));
        }
        return rxjs_1.empty();
