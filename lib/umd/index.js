(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "rxjs/Observable", "rxjs/add/observable/empty", "rxjs/add/observable/fromEvent", "rxjs/add/observable/interval", "rxjs/add/observable/timer", "rxjs/add/operator/do", "rxjs/add/operator/retryWhen", "rxjs/add/operator/scan", "rxjs/add/operator/skipWhile", "rxjs/add/operator/startWith", "rxjs/add/operator/switchMap"], factory);
    }
        ...
        return Observable_1.Observable.fromEvent(document, 'visibilitychange')
            ...
            if (isPageActive()) {
                return Observable_1.Observable.interval(options.interval, scheduler)
                    ...
                    .skipWhile(function () {
                    var elapsedTime = Date.now() - lastEmitTimestamp;
                    console.log(elapsedTime / 1000);
                    return elapsedTime < options.interval;
                })
